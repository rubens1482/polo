...
if (!empty($id_cliente) && is_numeric($id_cliente)):
	...
	$sql = 'SELECT id, matricula, tipo, situacao, nome, identidade, placa, veiculo, cidade, uf, empresa, foto, dataentrada, horaentrada, horasaida FROM tb_entrada WHERE id = :id';
		...
		<fieldset>
			...
			<?php else: ?>
			    ...
			    <div class="form-group">
			      ...
			      <input type="dataentrada" class="form-control" id="dataentrada" maxlength="10" name="dataentrada" value="<?=$cliente->dataentrada?>"placeholder="Informe a Data">
		
		        </div>
				
				<div class="form-group">
			      <label for="horaentrada">Hora Entrada:</label>
			      <input type="horaentrada" class="form-control" id="horaentrada" maxlength="10" name="horaentrada" value="<?=$cliente->horaentrada?>"placeholder="Informe a Hora de entrada">
		
		        </div>
				
				<div class="form-group">
			      <label for="horasaida">Hora de Saida:</label>
			      <input type="horasaida" class="form-control" id="horasaida" maxlength="10" name="horasaida" value="<?=$cliente->horasaida?>"placeholder="Informe a Hora de saida">
